...
declare type SomeRequired<T, K extends keyof T> = Pick<T, Exclude<keyof T, K>> & Required<Pick<T, K>>;
...
export declare type FeatureHubContextConsumerValue = SomeRequired<FeatureHubContextProviderValue, 'logger'>;
/**
 ...
 */
export declare const FeatureHubContextProvider: React.ProviderExoticComponent<React.ProviderProps<FeatureHubContextProviderValue>>;
/**
...
export declare const FeatureHubContextConsumer: {
    (props: React.ConsumerProps<SomeRequired<FeatureHubContextProviderValue, "logger">>): JSX.Element;
    displayName: string;
};
export {};
