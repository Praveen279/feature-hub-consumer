...
import { isDomFeatureApp, isFeatureApp, isReactFeatureApp } from './internal/type-guards';
...
export function FeatureAppContainer(props) {
    return (React.createElement(FeatureHubContextConsumer, null, ({ featureAppManager, logger }) => (React.createElement(InternalFeatureAppContainer, Object.assign({ featureAppManager: featureAppManager, logger: logger }, props)))));
}
